...
var findAllData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, userqueries_1.getAllData)()];
            case 1:
                Datas = _a.sent();
                Datas.json;
